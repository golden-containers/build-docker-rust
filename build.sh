...
docker build 1.58.1/bullseye/ ${BUILD_ARGS} \
    --tag ${GCI_URL}/rust:1.58.1-bullseye

docker build 1.58.1/alpine3.14/ ${BUILD_ARGS} \
    --tag ${GCI_URL}/rust:1.58.1-alpine3.14
